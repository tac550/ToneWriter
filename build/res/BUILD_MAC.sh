...
jpackage --name ToneWriter --input jar/ --main-jar tonewriter.jar --java-options "--enable-preview -Xms256m -Xmx4096m -Duser.dir=\$ROOTDIR" \
--icon TWIcon.icns --runtime-image java-runtime/ --type app-image --app-version 0.8 --dest ../mac/ && \
...
cd ../mac/ && \
zip -r ToneWriter0.8.app.zip ToneWriter.app
