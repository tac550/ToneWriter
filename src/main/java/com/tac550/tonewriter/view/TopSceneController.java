...
public class TopSceneController {
	...
	@FXML private void handlePageSetup() {
		FXMLLoaderIO.loadFXMLLayoutAsync("/fxml/PageSetupView.fxml", loader -> {
	...
	@FXML private void handleAbout() {
		FXMLLoaderIO.loadFXMLLayoutAsync("/fxml/AboutScene.fxml", loader -> {
	...
	public void addTab(String title, int at_index, ProjectItem loadedItemCache,
		...
		FXMLLoaderIO.loadFXMLLayoutAsync("/fxml/MainScene.fxml", loader -> {
